...
- In the block `Figure S3`, the file `r_tr2.dat`  is used to plot **Figure S3**. This file is derived by running `adaf_tr.for` in which `lum_x.dat` is the input file contains the Compton, disk and total X-ray luminosity displayed in **Figure 2A**.
