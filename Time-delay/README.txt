...
- iccf.py: the script to plot the ICCF in Figure S1
...
How-to-use:
1. Compile: $ gcc -O2 piccf_mc.c -o libpiccf_mc.out -lm -lgsl -lplplot -lgslcblas
2. Run: $ ./libpiccf_mc.out
...
$ python iccf.py
Note that, after the "data1" and "data2" are specified with the respective filenames for two light currves (see above), the script will plot the resulting ICCF analysis.
