...
data2 = np.loadtxt("data_use/radio_58380_296.txt")
data1 = np.loadtxt("data_use/corona_58380_1sigma.txt")
...
ax1.text(13,0.75,"A",fontsize=30,fontweight='bold')
#plt.show()
plt.title("Radio  vs.  X-ray",fontsize=28)
